...
const Question9 = () => {
  ...
  return (
    ...
    <div className={`${stat=="wrong"?"show":"hide"}`}><iframe src="https://lottie.host/?file=95e08e8c-8c5c-4e1a-8e52-66b1f9bc5c51/k75DUPenEI.json"></iframe></div>
      <NavLink className="navlink" to="/Question10"><span className={reveal=='true'?'nextques':'hide'}>&#9992;</span></NavLink>
   ...
   SO TELL WHAT ACCORDING TO YOU IS MY FAVOURITE PICTURE OF YOUR'S
    </div>

    <div className='set1'>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>This one &nbsp;     <img src={pic3} alt="" className='ansphoto'/>    </div>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>This one &nbsp;     <img src={pic2} alt="" className='ansphoto'/>   </div>
    </div>
    <div className='set2'>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>This one &nbsp;     <img src={pic4} alt="" className='ansphoto'/>    </div>
    <div className={`ques ${reveal=='true'?'cor':''}`} onClick={()=>{changeclass("correct")}}>This one &nbsp;     <img src={pic1} alt="" className='ansphoto'/>    </div>
    </div>
