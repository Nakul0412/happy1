...
const Question2 = () => {
  ...
  return (
    ...
    <div className={`${stat=="wrong"?"show":"hide"}`}><iframe src="https://lottie.host/?file=95e08e8c-8c5c-4e1a-8e52-66b1f9bc5c51/k75DUPenEI.json"></iframe></div>
      <NavLink className="navlink" to="/Question3"><span className={reveal=='true'?'nextques':'hide'}>&#9992;</span></NavLink>
    ...
    LET'S SEE HOW MUCH YOU REMEBER  ME SO TELL WHICH PICTURE WAS OUR FIRST PICTURE TOGETHER?
    </div>

    <div className='set1'>
    <div className={`ques ${reveal=='true'?'cor':''}`} onClick={()=>{changeclass("correct")}}>This one &nbsp;     <img src={actual} alt="" className='ansphoto'/>    </div>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>This one &nbsp;     <img src={fake} alt="" className='ansphoto'/>   </div>
    </div>
    <div className='set2'>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("correct")}}>This one &nbsp;     <img src={fake2} alt="" className='ansphoto'/>    </div>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>None of these  </div>
    </div>
