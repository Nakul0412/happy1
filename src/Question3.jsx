...
const Question3 = () => {
  ...
  return (
    ...
    <div className={`${stat=="wrong"?"show":"hide"}`}><iframe src="https://lottie.host/?file=95e08e8c-8c5c-4e1a-8e52-66b1f9bc5c51/k75DUPenEI.json"></iframe></div>
      <NavLink className="navlink" to="/Question4"><span className={reveal=='true'?'nextques':'hide'}>&#9992;</span></NavLink>
    ...
    <div className="question" >
      SO YOU MUST HAVE GOTTEN THE PREVIOUS ONE RIGHT TELL ME THIS WHATS THE LOCATION OF THIS  MASTERPIECE?
    </div>

    <div className='set1'>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>Outside your home</div>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>Outside Elante</div>
    </div>
    <div className='set2'>
    <div className={`ques ${reveal=='true'?'cor':''}`} onClick={()=>{changeclass("correct")}}>Outside  House of Garden</div>
