...
import pol1 from './pol1.jpg'
import pol2 from './pol2.jpg'
import pol3 from './pol4.jpg'
const Question10 = () => {
  ...
  return (
    ...
    <div className={`${stat=="wrong"?"show":"hide"}`}><iframe src="https://lottie.host/?file=95e08e8c-8c5c-4e1a-8e52-66b1f9bc5c51/k75DUPenEI.json"></iframe></div>
      <NavLink className="navlink" to="/PostCredit"><span className={reveal=='true'?'nextques':'hide'}>&#9992;</span></NavLink>
    ...
    OK THIS IS THE LAST PREVIOUS YEAR I GAVE YOU POLARAIDS WHICH PICTURE WAS NOT IN THE POLAROIDS?
    </div>

    <div className='set1'>
    <div className={`ques ${reveal=='true'?'cor':''}`} onClick={()=>{changeclass("correct")}}>This one &nbsp;     <img src={pol3} alt="" className='ansphoto'/>    </div>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>This one &nbsp;     <img src={pol2} alt="" className='ansphoto'/>   </div>
    </div>
    <div className='set2'>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>This one &nbsp;     <img src={pol1} alt="" className='ansphoto'/>    </div>
    <div className={`ques ${reveal=='true'?'wor':''}`} onClick={()=>{changeclass("wrong")}}>This one &nbsp;     <img src={pic1} alt="" className='ansphoto'/>    </div>
    </div>
